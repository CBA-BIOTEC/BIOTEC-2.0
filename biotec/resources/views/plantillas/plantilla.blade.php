...
<html lang="en">
  ...
  <body class="animated-background" style="font-family: 'Father Bold', sans-serif;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-succes fixed-top p-4 rounded">
      <div class="container-fluid">
        
        <!-- Enlace al logo que redirige a la página principal -->
        <a class="navbar-brand" href="/">
          <!-- Imagen del logotipo con tamaño fijo -->
          <img src="images/bio/Logo.png" alt="Logo" style="width:240px border-radius: 4px; margin-right: 80px;" class="imglogo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-5"> <!-- ms-auto alinea los elementos a la derecha -->
            ...
            <li class="nav-item">
              <a class="nav-link" href="/biotec" style="font-family: 'Father Bold', sans-serif;">Home</a>
            </li>

            <!-- Menú desplegable para la sección Introduction -->
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="introductionDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-family: 'Father Bold', sans-serif;">
                Introduction
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="laboratoryDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-family: 'Father Bold', sans-serif;">
                Laboratory
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="materialDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-family: 'Father Bold', sans-serif;">
                  Material
              </a>
                  ...
                  <div class="socialcontainer">
                    <div class="icon social-icon-3-3">
                      <a href="https://www.linkedin.com/in/tu-usuario/" target="_blank">
                        ...
                        >
                          <path
                            d="M100.28 448H7.4V149.56h92.78zm-46.14-341a53.33 53.33 0 1 1 53.33-53.33 53.34 53.34 0 0 1-53.33 53.36zM447.8 448h-92.65V302.4c0-34.7-.7-79.2-48.26-79.2-48.33 0-55.7 37.8-55.7 76.8V448h-92.65V149.56h88.94v40.78h1.26c12.4-23.5 42.6-48.26 87.64-48.26 93.66 0 110.89 61.6 110.89 141.77V448z"
                          ></path>
                        </svg>
                      </a>
                    </div>
